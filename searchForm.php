...
<form class="blogSearch" role="search" method="get" action="<?php echo esc_url( home_url('/') ); ?>">
  <label class="sr-only" for="q"><?php esc_html_e('Search blog', 'yourtheme'); ?></label>
  <input
    id="q"
    class="searchInput"
    type="search"
    name="s"
    placeholder="<?php esc_attr_e('Search articles…', 'yourtheme'); ?>"
    value="<?php echo esc_attr( get_search_query() ); ?>"
  />
  <button class="searchBtn" type="submit" aria-label="<?php esc_attr_e('Search', 'yourtheme'); ?>">
